...
@section('keywords', 'Finance, Lumpsum Calculator, How It Works, Why Choose Mutual Funds, Types of Mutual Funds, Who Should Invest')
@push('css')
               ...
               <div class="tab_over_all_box">
                  ...
                  <div class="s_tab_wrapper">
                     <div class="s_tabs_content">
                        <div class="s_tab fade active-tab show" id="lumpsumcalculator">
                                          ...
                                          <div class="sip-amount-input-box">
                                             <div class="sip-inner-box">
                                                ...
                                                <div class="sip-input-container">
                                                   ...
                                                   <input type="text" class="lumpsum-input ao-input-number" data-input-name="lumpsumAmount" maxlength="15" placeholder="0" value="5,000">
                                          ...
                                          <div class="content_bx">
                                             <div class="opening-statement">
                                                ...
                                                <div class="investment-amount">
                                                   <span class="rupee-symbol">₹</span>
                                                   <span class="amount" id="Lumpsum-total-value">0</span>
                                                </div>
                                             </div>
                                             <div class="graph">
                                                <div class="SIP-chart-parent">
                                                   <div class="canvas-div ebitda-chart-child">
                                                      <canvas id="LumpsumPieChart" height="257" width="257"></canvas>
                                                         ...
                                                         <div class="legend-parent">
                                                            ...
                                                            <div class="legend-data">
                                                               ...
                                                               <p class="legend-value SIP-initial-value">
                                                                  <span> ₹ </span>
                                                                  <span id="Lumpsum-initial-value">0</span>
                                                               </p>
                                                            </div>
                                                         </div>
                                                         <div class="legend-parent">
                                                            ...
                                                            <div class="legend-data">
                                                               ...
                                                               <p class="legend-value SIP-final-val">
                                                                  <span> ₹ </span>
                                                                  <span id="Lumpsum-final-val">0</span>
                                                               </p>
                                                            </div>
                                                         </div>
                                                      </div>
...
<script type='text/javascript' src="{{ asset('fronted/js/pages/lumpsum-calculator.js') }}"></script>
@endpush