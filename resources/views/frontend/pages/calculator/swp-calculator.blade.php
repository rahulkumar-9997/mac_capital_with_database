...
@section('keywords', 'Finance, SWP Calculator, How It Works, Why Choose Mutual Funds, Types of Mutual Funds, Who Should Invest')
@push('css')
   ...
   <div class="container">
      <div class="row default_row">
         <div class="full_width_box">
            ...
            <!--===============spacing==============-->
            <section class="tabs_all_box tabs_all_box_start type_two calculator-section">
               <div class="tab_over_all_box">
                  ...
                  <div class="s_tab_wrapper">
                     <div class="s_tabs_content">
                        <div class="s_tab fade active-tab show" id="swpcalculator">
                           <div class="tab_content one">
                              <div class="section-seperator-40-60">
                                 <div class="row">
                                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-xs-12 mb-2 mb-lg-0 mb-xl-0 calc-options-container swp-calc">
                                       ...
                                       <div class="simple-sip-container active swp-calc-form">
                                          <div class="sip-amount-input-box">
                                             <div class="sip-inner-box">
                                                <p>ENTER AMOUNT</p>
                                                <div class="sip-input-container">
                                                   <span class="rupee-symbol">₹</span>
                                                   <input type="text" class="lumpsum-input ao-input-number" data-input-name="lumpsumAmount" maxlength="15" placeholder="0" value="5,00,000">
                                                   <span class="clone-sip-input"></span>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="range-sliders-container">
                                             <div class="details" id="fixed-details-div">
                                                <div class="details-child details-child-one">
                                                   <p>Monthly Withdrawal</p>
                                                   <div>
                                                      <span class="rupees">₹</span>
                                                      <input type="number" min="500" max="50000" step="10" value="10000" id="fc-pa-txt" style="width: 5ch;">
                                                   </div>
                                                </div>
                                                <input type="range" id="fc-pa" min="500" max="50000" step="10" value="10000" class="range-slider ao-range-slider">
                                             ...
                                             <div class="expected-ror-slider-container">
                                                <div class="heading-wrapper">
                                                   ...
                                                   <div class="fake-input-container">
                                                      <input type="number" class="expected-ror-input ao-input-number" id="rate-txt" data-input-name="expectedROR" placeholder="0" min="8" max="30" step="0.01" value="8">
                                             ...
                                             <div class="graph">
                                                <div class="SIP-chart-parent">
                                                   <div class="canvas-div ebitda-chart-child">
                                                      <canvas id="SWPPieChart" height="257" width="257"></canvas>
                                                         ...
                                                         <div class="legend-parent">
                                                            ...
                                                            <div class="legend-data">
                                                               ...
                                                               <p class="legend-value SIP-initial-value">
                                                                  <span> ₹ </span>
                                                                  <span id="swp-invested-amt">0</span>
                                                               </p>
                                                            </div>
                                                         </div>
                                                         <div class="legend-parent">
                                                            ...
                                                            <div class="legend-data">
                                                               <p class="legend-txt">Total Withdrawal</p>
                                                               <p class="legend-value SIP-final-val">
                                                                  <span> ₹ </span>
                                                                  <span id="swp-withdrawal-amt">0</span>
                                                               </p>
                                                            </div>
                                                         </div>
                                                         <div class="legend-parent">
                                                            <div class="legend-bg legend-bg-violet"></div>
                                                            <div class="legend-data">
                                                               <p class="legend-txt">Final value</p>
                                                               <p class="legend-value SIP-final-val">
                                                                  <span> ₹ </span>
...
<script type='text/javascript' src="{{ asset('fronted/js/pages/swp-calculator.js') }}"></script>
@endpush