...
Route::POST('interested-shares-enquiry', [FrontHomeController::class, 'interestedSharesEnquiryForm'])->name('interested-shares-enquiry');
Route::POST('interested-shares-enquiry/store', [FrontHomeController::class, 'interestedSharesEnquiryFormSubmit'])->name('interested-shares-enquiry.store');
